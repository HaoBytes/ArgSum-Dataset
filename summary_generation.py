...
def load_dataset(input_file) -> pd.DataFrame:
    ...
    data_dict = pd.read_csv(input_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="gpt-3.5-turbo",
                        help="The pretrained model to use for dataset generation. Currently, only variants of GPT3 are supported.")
    ...
    output_df.to_csv(output_dir+"generated_summary",index=False)
